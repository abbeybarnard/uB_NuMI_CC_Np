...
def truth_and_eff(true_var, bins, xlower, xupper, cut, datasets, isrun3, pot=None, ymax1=None, ymax2=None, xlbl=None, save=False):
    ...
    if save: 
        plt.savefig("/Users/abarnard/phd/ccnp/plots/"+horn+"/"+horn+"_"+true_var+"truth_eff.pdf", 
...
def comb_truth_and_eff(true_var, bins, df_infv, df_sel, xlbl, save):
    ...
    if save:
        plt.savefig("/Users/abarnard/phd/ccnp/plots/both/both_truth_sig.pdf", transparent=True, bbox_inches='tight')    
    ...
    if save:
            plt.savefig("/Users/abarnard/phd/ccnp/plots/both/both_truth_eff.pdf", transparent=True, bbox_inches='tight')    
