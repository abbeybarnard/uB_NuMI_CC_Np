...
class NuMIDetSys: 
    ...
    def makehist_detsys(self, variation, isrun3, output_file, xvar, bins, cut=None, useBDT=False, 
        ...
        input_path = "/Users/abarnard/phd/pelee_ntuples/"+run+"/systematics/detvar/" #+ "slimmed/qualcuts/"
        ...
        for i, df in enumerate([df_standard, df_intrinsic]):
            ...
            #                  & ((df.nu_pdg==12) | (df.nu_pdg==-12)) & (df.ccnc==0) & (df.nproton>0) & (df.npion==0) & (df.npi0==0)
    ...
    def plot_variations(self, var, bins, file, ISRUN3, axis_label=None, save=False, plot=False, background_subtraction=False): 
        ...
        path = "/Users/abarnard/phd/pelee_ntuples/"+run+"/systematics/detvar/" #+ "slimmed/qualcuts/"
