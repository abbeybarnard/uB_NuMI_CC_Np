...
// slimmer_qualcuts(file_name)
// Dirt, overlay... 
void slimmer_qualcuts(TString fname)
{
  
   // Get old file, old tree and set top branch address
   // Directory where the file with name fname is being read from! 
   // TString dirorigin = "/exp/uboone/data/users/kmiller/uBNuMI_CCNp/ntuples/run3b/cv/"; 
   TString dirorigin = "/exp/uboone/data/users/abarnard/pelee_ntuples/run_3/ar_run_3/"; 

   // Directory where the file will be saved!  
   // TString dir = "/exp/uboone/data/users/kmiller/uBNuMI_CCNp/ntuples/run3b/cv_slimmed/qualcuts/"; 
   TString dir = "/exp/uboone/data/users/abarnard/pelee_ntuples/run_3/ar_run_3/slimmed/";
